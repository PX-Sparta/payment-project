...
@Builder
@AllArgsConstructor
public class MembershipRankPolicyResponse {
    ...
    public static MembershipRankPolicyResponse from(MembershipRankPolicy policy) {
        return MembershipRankPolicyResponse.builder()
                .gradeCode(policy.getRankCode())
                .gradeName(policy.getRankName())
